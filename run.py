"""
From pytorch-lightning-template for model implementation
"""
...
from dataset import TripletData, custom_collate
...
if __name__ == "__main__":
    ...
    # setting
    hparams = addict.Addict(load_hparams_from_yaml(args.setting))
    update_hparams(hparams, vars(args))
    print("setting:", hparams)

    train_set = TripletData(hparams.train_data_path)
    val_set = TripletData(hparams.val_data_path)
